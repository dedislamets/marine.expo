...
import { View, Button, StyleSheet, TouchableOpacity, Text,ActivityIndicator,Image } from "react-native";
...
const ScaledImage = props => {
  ...
  return (
      height ?
          <View style={{ height: height, width: width, borderRadius: 5, backgroundColor: "lightgray", marginBottom: 20 }}>
              <Image
